Public Class Crop
    ...
    Private Sub ToolStripButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCrop.Click
        ...
        CropMod.CroppedImage = CaptureImage(Me.Location.X, Me.Location.Y, Me.ClientSize.Width, Me.ClientSize.Height)
        CropMod.ReCroppedImage = New Bitmap(CroppedImage, New Size(OriWidth, OriHeight))

        If Photo__Editor.chkCropOpt.Checked = True Then
            Photo__Editor.picCrop.Image = CropMod.ReCroppedImage
        ...
        ElseIf Photo__Editor.chkCropOpt.Checked = False Then
            Photo__Editor.picCrop.Image = CropMod.CroppedImage
